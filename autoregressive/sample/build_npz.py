...
from utils.logger_copy import create_logger
...
def create_npz_from_sample_folder(sample_dir, num=50_000):
    ...
    samples = []
    for i in tqdm(range(len(png_files)), desc="Building .npz file from samples"):
        sample_pil = Image.open(f"{sample_dir}/{png_files[i]}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--num-fid-samples", type=int, default=8576)
